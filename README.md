...
1. **Tela de Listagem:** exibe todas as tarefas salvas.
2. **Tela de Cadastro/Edição:** permite criar ou modificar tarefas.
3. **Tela de Detalhes:** exibe informações completas da tarefa selecionada.
